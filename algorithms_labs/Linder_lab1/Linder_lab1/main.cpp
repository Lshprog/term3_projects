...
//    return matrix;
//}
//double** create_matrix_random(const int& a,const int& b) {
...
//
//    first->matrix = create_matrix_random(a,b);
//    second->matrix = create_matrix_random(c,d);
//
//    print(first);
//    cout << endl;
//    cout << endl;
...
//
//
//    Matrix* result_brute_force = matrix_multiply(first,second);
//    print(result_brute_force);
//
//    cout << endl;
//    cout << endl;
//
//    Matrix* result = strassen_multiply(first,second);
//    print(result);*/
//
//   
//
